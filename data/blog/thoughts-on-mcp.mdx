...
summary: "Everybody's talking about MCP, but what's all the hype for? In this post I dig into what about MCP has everyone so excited."
date: 07/07/2025
...
## MCP for Engineers
MCP is popular with engineers because it allows them to level up their AI-powered coding tools like Cursor, Windsurf, Claude code, and even 
custom agents or agentic workflows with new capabilities, with relatively little configuration.

I already gave the example of Puppeteer, and there are several more below. For engineers, MCP is a way to make coding agents smarter, more efficient, 
and more aware of important project context. 
