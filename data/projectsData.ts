...
const projectsData: Project[] = [
  {
    title: "Kydenticon: Zero-Dependency Github-Style Identicons in Typescript",
    description:
      "A zero-dependency TypeScript library for generating beautiful, deterministic GitHub-style identicons with PNG and SVG support. Built with modern tooling and ready-to-use Next.js integration.",
    href: "https://github.com/k-mistele/kydenticon",
    imgSrc: "/images/identicon.png",
  },
  {
